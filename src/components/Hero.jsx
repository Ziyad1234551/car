...
export const Hero = () => {
  ...
  return (
    <div data-aos="fade-left" name="about" className='lg:flex-row  flex flex-col md:flex-row sm:flex-col my-10  lg-h-auto lg:h-[50vh] items-center justify-between max-w-full lg:max-w-[1228px] mx-auto lg:px-0 px-10'>
