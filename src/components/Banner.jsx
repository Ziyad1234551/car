...
export const Banner = () => {
  ...
  return (
    <div data-aos="fade-bottom" className='lg:w-[1028px] md:[700px] px-8 car mx-auto py-4 md:h-[300px] h-auto lg:h-[300px] bg-cover bg-center text-white my-10 rounded-lg' style={{
