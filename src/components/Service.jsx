...
export const Service = () => {
  return (
    <div data-aos="fade-left" className='lg:max-w-[1428px] md:w-full w-[300px] lg:items-center px-2  lg:flex-row md:flex-row flex-col  flex justify-around gap-10  my-[100px]'>
         <div>
        ...
        <div className='-start  my-0 lg:my-[40px]'>
            <h1 className="dm-display  md:text-5xl text-5xl lg:text-[60px] text-blue-500 font-bold ">Our Services</h1>
